#!/usr/bin/env python3
"""PM standup 2026-06-15 — upsert standup + link planning artifacts."""
...
def upsert_standup(conn) -> None:
    ...
    sections = {
        "done": [
            "Agent: HQ Inbox checklist → planning/hq-inbox-approval-checklist-2026-06-15.md",
            "Agent: Office landlord outreach → planning/office-landlord-outreach-2026-06-15.md",
            "Agent: Denis action pack → planning/denis-action-pack-2026-06-15.md",
            "Agent: Verified office shortlist URLs still in data/office-top40.md",
        ],
        "ongoing": [
            "Denis: PO apply method + first publish channel (no reply since 2026-06-05)",
            "Denis: Office Plovdiv — outreach pack ready; pick 3 + contact landlords",
        ...
        "today": [
            ...
            "Denis: Office — pick 3; use planning/office-landlord-outreach-2026-06-15.md",

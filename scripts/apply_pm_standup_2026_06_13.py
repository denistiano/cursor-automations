#!/usr/bin/env python3
"""PM standup 2026-06-13 — upsert standup + link planning artifacts."""
...
def upsert_standup(conn) -> None:
    ...
    sections = {
        "done": [
            "Agent: Scheduled standup audit — no Denis replies since 2026-06-10",
            "Agent: Stale-item analysis → planning/denis-action-pack-2026-06-13.md",
        ],
        "ongoing": [

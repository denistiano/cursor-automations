#!/usr/bin/env python3
"""PM standup 2026-07-31 — upsert standup + link planning artifacts."""
...
def upsert_standup(conn) -> None:
    ...
    sections = {
        "done": [
            "Agent: Re-validated office A/B/C live; 10915009 delisted → planning/office-shortlist-validation-2026-07-31.md",
            "Agent: Carryover analysis (yesterday Today, no progress) → planning/carryover-analysis-2026-07-31.md",
            "Agent: PO publish readiness checklist → planning/po-publish-readiness-2026-07-31.md",
            "Agent: Denis batch prompt → planning/denis-agent-prompt-2026-07-31.md",
        ],
        "ongoing": [
            "Denis: PO apply method + first publish channel (no reply since 2026-06-05 — day 56)",
            "Denis: Office Plovdiv — A/B/C validated; pick 3 + contact landlords",
            "Denis: HQ Inbox — 4 automations + 3 social drafts open (day 51+)",
        ...
        "today": [
            ...
            "Denis: Office — confirm visits A/B/C (planning/office-shortlist-validation-2026-07-31.md)",

#!/usr/bin/env python3
"""PM standup 2026-08-17 — upsert standup entry in hq.db."""
...
def upsert_standup(conn) -> None:
    ...
    sections = {
        "done": [
            ...
            "Agent: PM standup 2026-08-17 + stalled-item analysis",
        ],
        "ongoing": [
            "Denis: PO apply + JD — jobs/product-owner body 0 bytes (day 73)",
        ...
        "today": [
            ...
            "Denis: PO apply + channels — use quickstart",

#!/usr/bin/env python3
"""PM standup 2026-08-11 — upsert standup + link planning artifacts."""
...
def upsert_standup(conn) -> None:
    ...
    sections = {
        "done": [
            "Agent: Office re-scrape (1315 listings) + re-rank → data/office-top40.md",
            "Agent: A′/B′/C revalidated → planning/office-shortlist-refresh-2026-08-11.md",
            "Agent: Carryover analysis → planning/carryover-analysis-2026-08-11.md",
            "Agent: Denis batch prompt → planning/denis-agent-prompt-2026-08-11.md",
        ],
        "ongoing": [
            "Denis: PO apply method + first publish channel (no reply since 2026-06-05 — day 67)",
            "Denis: Office Plovdiv — A′/B′/C revalidated; pick 3 + contact landlords",
            "Denis: Brand sprint days 1–4 unanswered (day 53)",
            "Denis: HQ Inbox — 4 automations + 3 social drafts open (day 62)",
        ...
        "today": [
            ...
            "Denis: Office — confirm A′/B′/C from planning/office-shortlist-refresh-2026-08-11.md",

#!/usr/bin/env python3
"""PM standup 2026-08-07 — upsert standup + link planning artifacts."""
...
def upsert_standup(conn) -> None:
    ...
    sections = {
        "done": [
            ...
            "Agent: Carryover analysis (1d; PO day 63) → planning/carryover-analysis-2026-08-07.md",
            "Agent: Denis agent prompt pack → planning/denis-agent-prompt-2026-08-07.md",
        ],
        "ongoing": [
            "Denis: PO apply method + first publish channel (no reply since 2026-06-05 — day 63)",
            "Denis: Office Plovdiv — pick 3 from revised shortlist (A′/B′/C)",
            "Denis: HQ Inbox — 4 automations + 3 social drafts open (day 58+)",

#!/usr/bin/env python3
"""PM standup 2026-08-05 — upsert standup + link planning artifacts."""
...
def upsert_standup(conn) -> None:
    ...
    sections = {
        "done": [
            ...
            "Agent: Carryover analysis (1d; PO day 61) → planning/carryover-analysis-2026-08-05.md",
            "Agent: Denis agent prompt pack → planning/denis-agent-prompt-2026-08-05.md",
        ],
        "ongoing": [
            "Denis: PO apply method + first publish channel (no reply since 2026-06-05 — day 61)",
            "Denis: Office Plovdiv — pick 3 from revised shortlist (A′/B′/C)",
            "Denis: HQ Inbox — 4 automations + 3 social drafts open (day 56+)",
        ...
        "blockers": [
            "PO apply → action 430; jobs/product-owner body empty — po-publish-readiness-2026-08-04.md",
            "Office — previous Kapana picks removed; see office-shortlist-validation-2026-08-04.md",

#!/usr/bin/env python3
"""PM standup 2026-06-14 — upsert standup + link planning artifacts."""
...
def upsert_standup(conn) -> None:
    ...
    sections = {
        "done": [
            "Agent: Office shortlist validation — 5/5 targets still in scrape (329 listings)",
            "Agent: HQ Inbox checklist → planning/hq-inbox-approval-checklist-2026-06-14.md",
            "Agent: Denis action pack → planning/denis-action-pack-2026-06-14.md",
        ],
        "ongoing": [

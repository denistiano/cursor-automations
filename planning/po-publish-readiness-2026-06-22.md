# PO publish readiness — 2026-06-22

**Blocker:** `input-blocker-po-apply-method-publish-channels` (priority 1)  
**Days without Denis reply on PO apply:** 17 (since 2026-06-05)  
...
| `jobs/product-owner` in hq.db | `position_text: ""`, body empty |
...
**Suggested default:** Google Form URL + publish first on LinkedIn (no Easy Apply until company page exists).  
...
- Publish checklist in `tasks/pm-agent-drafts-build`

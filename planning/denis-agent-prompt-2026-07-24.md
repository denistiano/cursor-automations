# Denis batch agent prompt — 2026-07-24
...
- Last standup: **2026-07-23**. No Denis inbox replies since **2026-06-10** (day 44+).
- **P1 blocker:** PO job — `jobs/product-owner` body is empty; fast-track at `planning/po-apply-fast-track-2026-07-21.md`.
- **Office:** Live re-check 2026-07-24 — A/B/C still live; **B (10481212) expires ~10 days**. See `planning/office-shortlist-validation-2026-07-24.md`.
- **HQ Inbox:** 4 automations + 3 social drafts still `open`.
- **Brand sprint:** Days 1–4 unanswered since 2026-06-22 (32 days stale).
- **Path:** Landing vs deck not chosen — `planning/landing-vs-deck-decision-brief.md`.

## What we need to achieve

Unblock hiring (PO), office search (contact B urgently), marketing automations, brand positioning, and public-facing asset path — then sync hq.db and post Slack confirmations.
...
7. Upsert standup `2026-07-24` with Done / Today / Blockers / Agent next.

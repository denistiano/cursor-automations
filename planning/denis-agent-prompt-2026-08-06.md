# Denis → agent prompt pack (2026-08-06)
...
Vibe Coders Academy is a practitioner-first Cursor/AI cohort in Plovdiv — students ship real repos, automations, and landing pages. We are pre-launch: PO hire, office lease, brand plan, and public assets (landing/deck, social) are waiting on Denis decisions. Last Denis HQ Inbox reply: 2026-06-10. PO blocker day 62; office shortlist A′/B′/C re-validated 2026-08-06 (still listed on 2026-08-03 scrape).
...
### Office visits (A′/B′/C validated 2026-08-06 — still listed)

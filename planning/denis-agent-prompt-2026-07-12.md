# Denis → agent batch prompt (2026-07-12)
...
Vibe Coders Academy is a practitioner-first Cursor/agent engineering cohort in Plovdiv, Bulgaria — **not** SoftUni-style no-code vibe coding. HQ dashboard at `web/` tracks tasks via `actions` collection. Last Denis inbox replies: **2026-06-10**. Priority blockers open **32–37 days**.
...
See `planning/po-publish-checklist-2026-07-12.md`.
...
Optional: `remote=… | type=… | comp=…`

### Priority 1 — Brand sprint day 1 (sprint +20d overdue)

See `planning/brand-sprint-day1-decision-brief-2026-07-11.md` for suggested defaults.
...
**Fast path (if defaults OK):** copy the suggested reply from the day1 brief verbatim.

### Priority 2 — Office Plovdiv (A/B/C verified live 2026-07-12)

See `planning/office-shortlist-verify-2026-07-12.md`. Outreach: `planning/office-landlord-outreach-2026-06-15.md`.
...
### Priority 2 — HQ Inbox batch (7 items)

See `planning/hq-inbox-impact-2026-07-12.md`.
...
7. **Standup:** Upsert today's date with Done / Today (max 3) / Blockers / Agent next

# Denis action pack — batch replies (2026-07-04)

**No Denis Slack replies since 2026-06-10 (day 24).** Copy blocks into standup channel or HQ Inbox.
...
Refs: `planning/po-publish-readiness-2026-07-04.md`, `planning/po-jd-expanded-draft-2026-06-19.md`

---

## 2. Brand sprint day 1 (priority 1 — 12 days overdue)

```
brand day1: ICP=[…] — NOT for=[…] — secret sauce=[bullet1; bullet2; bullet3] — ops=[full-time PO | consultant | hybrid]
```

Ref: `planning/brand-sprint-catchup-2026-07-04.md`

---

## 3. Office — pick 3 visits (unchanged after re-rank)

```
Office visits: 11135459, 10481212, 4734755
```

Refs: `planning/office-url-check-2026-07-04.md`, `planning/office-landlord-outreach-2026-06-15.md`
...
## 5. Landing vs deck (optional — or defer to brand day 3)

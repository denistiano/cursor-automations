# Denis batch agent prompt — 2026-07-21
...
- Last standup: **2026-07-20**. No Denis inbox replies since **2026-06-10** (day 41+).
- **P1 blocker:** PO job — `jobs/product-owner` body is empty; fast-track at `planning/po-apply-fast-track-2026-07-21.md`.
- **Office:** A+B live (2026-07-21). **Pick C is hourly (€25.56/2–3h), not monthly** — see `planning/office-shortlist-validation-2026-07-21.md`. B listing expires ~13 days.
...
Office visits: [Kapana 11108782, широк център 10481212] — C: [negotiate YMCA package | swap 11237117 | skip]
...
7. Upsert standup `2026-07-21` with Done / Today / Blockers / Agent next.
